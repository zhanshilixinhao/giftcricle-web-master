    ...
    <div>
      <el-card :body-style="{ padding: '12px' }">
        ...
        <el-form :model="ruleForm" :label-position="left" ref="ruleForm" label-width="100px">
          <el-row :gutter="24">
            <el-col :span="12">
              <el-form-item label="开户人姓名" prop="cardHolder">
                <el-input v-model="ruleForm.cardHolder" placeholder="开户人姓名" type="text" ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="银行卡号" prop="cardNo">
                <el-input v-model="ruleForm.cardNo" placeholder="银行卡号" type="text" ></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="24">
            <el-col :span="12">
              <el-form-item label="银行名称" prop="bank">
                <el-select v-model="ruleForm.bank" filterable placeholder="请选择" style="width: 100%" icon="el-icon-search" @change="categoryChange">
                  <el-option
          ...
          <el-row :gutter="24">
            <el-col :span="12">
              <el-form-item label="提现用户昵称" prop="nickname">
                <el-input v-model="ruleForm.nickname" placeholder="提现用户昵称" type="text" ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="提现用户电话" prop="phone">
                <el-input v-model="ruleForm.phone" placeholder="提现用户电话" type="text" ></el-input>
              </el-form-item>
            </el-col>
          </el-row>
...
<script>
  ...
  import { getWithdrawList, getAllBank, handleUserWithdraw, handleBeginWithdraw } from '@/api/iwant/withdraw/withdraw'
  ...
  export default {
    ...
    methods: {
      ...
      handleBegin(index, row) {
        handleBeginWithdraw(row.id).then(re => {
      ...
      addSubmit() {
        ...
        handleUserWithdraw(id, status, this.messageForm.describe).then(re => {
          if (re.data.errCode === 0) {
            this.$message.success(re.data.msg)
            this.dialogVisible = false
            this.getList()
