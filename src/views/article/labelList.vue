<template>
  <div class="app-container" v-loading="loading2"
    ...
    <div>
      <el-card :body-style="{ padding: '12px' }">
        ...
        <el-form :model="ruleForm" :label-position="left" ref="ruleForm" label-width="100px">
          <el-row :gutter="24">
            <el-col :span="12">
              <el-form-item label="文章对象标题" prop="title">
                <el-input v-model="ruleForm.title" placeholder="文章对象标题" type="text"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
    ...
    <div>
      <el-card :body-style="{ padding: '12px' }">
        <el-button type="primary" @click="add()">添加对象</el-button>
      </el-card>
    </div>
    <br/>
    <el-table
    ...
    <!--文章对象-->
    <el-dialog title="文章对象" :visible.sync="dialogVisible" size="tiny">
      <el-form :model="addForm" :rules="rules" ref="addForm" label-width="100px">
        <el-form-item label="对象名称" prop="title">
          <el-input v-model="addForm.title" placeholder="对象名称" type="text"></el-input>
        </el-form-item>
      </el-form>
...
<script>
  ...
  import { getArticleLabel, addArLabel, updateArLabel, delArLabel } from '../../api/gift/article/label'
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        this.loading2 = true
        getArticleLabel(search).then(re =>{
          this.loading2 = false
      ...
      addInfo() {
        addArLabel({ title: this.addForm.title }).then(re => {
      ...
      updateInfo() {
        updateArLabel({ id: this.id, title: this.addForm.title }).then(re => {
          if (re.data.errCode === 0){
            this.$message({
              type: 'success',
              message: '修改成功'
